...
namespace QL_PHONGGYM.AdminPortal.Controllers
{
    public class LoaiKhachHangsController : Controller
    {
        ...
        {
            return View(db.LoaiKhachHang.ToList());
        }
        ...
        public ActionResult Details(int? id)
        {
            ...
            LoaiKhachHang loaiKhachHang = db.LoaiKhachHang.Find(id);
        ...
        public ActionResult Create([Bind(Include = "MaLoaiKH,TenLoai,MucGiam")] LoaiKhachHang loaiKhachHang)
        {
            ...
            {
                db.LoaiKhachHang.Add(loaiKhachHang);
                db.SaveChanges();
        ...
        {
            LoaiKhachHang loaiKhachHang = db.LoaiKhachHang.Find(id);
            db.LoaiKhachHang.Remove(loaiKhachHang);
            db.SaveChanges();
            return RedirectToAction("Index");
        }
